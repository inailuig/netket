...
vs = nk.vqs.MCState(sa2, ma, n_samples=16384 // jax.jax.process_count(), n_discard_per_chain=n_discard)


# TODO here we assume every rank has different seed; split manually?
vs.sampler_state = vs.sampler_state.replace(σ=put_global(vs.sampler_state.σ))
